...
<body>
	<div class="container-fluid text-center" style="height:120px; background-color:#CBE432; opacity:0.9;">
			<h1 id="mainHeading">REGISTERED DATA</h1>	
	</div>
	<center>
		<?php
		...
		if ($conn->connect_error) {
			...
			echo "<h3>Logs of Admission Data</h3>";
		}

		$sql = "SELECT username, password FROM students_login";
...
<center><h3><a href="submit.php">Back to Admin Section</a></h3></center>
</body>
</html>