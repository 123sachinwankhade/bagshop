...
<body>
  <div class="container-fluid text-center" style="height:120px; background-color:#CBE432; opacity:0.9;">
      <h1 id="mainHeading">FEEDBACK DATA</h1>  
  </div>
<form action="" method="POST">
<input type="text" name="fname" placeholder="enter name">
<input type="submit"name="fname" value="fname">
</form>
  ...
  <center>
    ...
    if ($conn->connect_error) {
      ...
      echo "<h3>Logs of Feedback Data</h3>";
    }

    $sql = "SELECT lname, description, email, contact, choice FROM feedback WHERE fname={$fname}";
