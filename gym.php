...
<div class="products_container grid">
		...
		<div class="product_button ml-auto mr-auto trans_200"><a href="payment.php">Buy Now</a></div>
							...
							<div class="product grid-item">
								<div class="product_inner">
									<div class="product_image"><img src="col/b2.jpg" alt=""></div>
									<div class="product_content text-center">
										<div class="product_title"><a href="product.html">wiki</a></div>
										<div class="product_price">1519.50</div>
										<div class="product_button ml-auto mr-auto trans_200"><a href="payment.php">Buy Now</a></div>
									</div>
								</div>	
							</div>
							...
							<div class="product grid-item sale">
								<div class="product_inner">
									<div class="product_image">
										<img src="col/b3.jpg" alt="">
										<div class="product_tag">sale</div>
									</div>
									<div class="product_content text-center">
										<div class="product_title"><a href="product.html">american</a></div>
							...
							<div class="product grid-item">
								<div class="product_inner">
									<div class="product_image">
										<img src="col/b4.jpg" alt="">
									</div>
									<div class="product_content text-center">
										<div class="product_title"><a href="product.html">wild carft</a></div>
							...
							<div class="product grid-item hot">
								<div class="product_inner">
									<div class="product_image">
										<img src="col/b5.jpg" alt="">
										<div class="product_tag">hot</div>
									</div>
									<div class="product_content text-center">
										<div class="product_title"><a href="product.html">camel mountain</a></div>
							...
							<div class="product grid-item new">
								<div class="product_inner">
									<div class="product_image">
										<img src="col/b6.jpg" alt="">
										<div class="product_tag">new</div>
									</div>
									<div class="product_content text-center">
										<div class="product_title"><a href="product.html">adidas</a></div>
